                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    Data guru belum ada. Silakan tambahkan segera di tab edit profile.
                                </div>
                                @endif
                                @if (session('success'))
                                ...
                                document.addEventListener("DOMContentLoaded", function() {
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            window.location.href =
                                                "{{ route('profile.show') }}#profile-edit";
                                        }
                                    });
                                    ...
                                    if (window.location.hash === "#profile-edit") {
                                        ...
                                        let tab = new bootstrap.Tab(document.querySelector(
                                            'button[data-bs-target="#profile-edit"]'));
                                        tab.show();
                                    }
                                });
                                </script>
                                ...
                                <form action="{{ route('profile.save') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div @if ($guru && $guru->photo) style="width: 150px; height: 150px;
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <textarea name="about" class="form-control" id="about"
                                        style="height: 100px">{{ $guru->about ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="birthPlace" class="col-md-4 col-lg-3 col-form-label">Birth
                                    Place</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="birth_place" type="text" class="form-control" id="birthPlace"
                                        value="{{ $guru->birth_place ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <select name="province" id="province" class="form-control">
                                        ...
                                        <option value="{{ $province->id }}" {{ $guru && $guru->province ==
                                            $province->name ? 'selected' : '' }}>
                                            {{ $province->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                <label for="lastEducation" class="col-md-4 col-lg-3 col-form-label">Last
                                    Education</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="last_education" type="text" class="form-control" id="lastEducation"
                                        value="{{ $guru->last_education ?? '' }}">
                                </div>
                            </div>
